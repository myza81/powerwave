...
NARI RELAY:
  Line 1: only 2 fields (station, device) — rev_year MISSING → default 1999
  ...
  Digital prefixes: Op_=protection operated (→DIG_TRIP), BI_=binary input,
                    VEBI_=virtual binary input
...
PMU CSV (Malaysian grid — confirmed from real files):
  ...
  Column prefix pattern: signals may have unit/bay prefix before core name
    e.g. "UNIT2_V1 Magnitude", "KAWA1_V1 Angle" → strip "WORD_" prefix
...
## ── PLANNING DOCUMENTS ─────────────────────────────────────────────────────
docs/PowerWave_Doc1_Skills_Knowledge_Base.docx
docs/PowerWave_Doc2_High_Level_Overview.docx
docs/PowerWave_Doc3_Implementation_Plan.docx
docs/PowerWave_Supplement_Merging_PMU.docx
docs/PowerWave_FeatureNote_ChannelSignalMapping.docx
docs/PowerWave_MasterDeveloperGuide.docx
